...
32. [ ] Authenticated Live Tennis API Free feasibility spike — Codex, GPT-5.6 Sol / high reasoning
    ...
    - The initial authenticated survey is complete. `docs/phase-2-provider-evaluation.md` records the confirmed contract and provider quirks. Four of ten distinct ATP live changes were observed; WTA live and exceptional statuses remain outstanding, so the gate stays open.
